...
#include "libs/g2o/g2o/core/sparse_block_matrix.h"
...
namespace WEB_SLAM {
  bool sortByVal(const pair<MapPoint *, int> &a,
                 const pair<MapPoint *, int> &b) {
  ...
  void Optimizer::BundleAdjustment(const vector<KeyFrame *> &vpKFs,
    ...
    vector<WEB_SLAM::EdgeSE3ProjectXYZ *> vpEdgesMono;
    vpEdgesMono.reserve(nExpectedSize);

    vector<WEB_SLAM::EdgeSE3ProjectXYZToBody *> vpEdgesBody;
    ...
    for (size_t i = 0; i < vpMP.size(); i++) {
      ...
      for (map<KeyFrame *, tuple<int, int>>::const_iterator mit =
        ...
        if (leftIndex != -1 && pKF->mvuRight[get<0>(mit->second)] < 0) {
          ...
          WEB_SLAM::EdgeSE3ProjectXYZ *e = new WEB_SLAM::EdgeSE3ProjectXYZ();
        ...
        if (pKF->mpCamera2) {
          ...
          if (rightIndex != -1 && rightIndex < pKF->mvKeysRight.size()) {
            ...
            WEB_SLAM::EdgeSE3ProjectXYZToBody *e =
                new WEB_SLAM::EdgeSE3ProjectXYZToBody();
    ...
    for (size_t i = 0; i < vpKFs.size(); i++) {
      ...
      if (nLoopKF == pMap->GetOriginKF()->mnId) {
        ...
        pKF->mTcwGBA = Sophus::SE3d(SE3quat.rotation(), SE3quat.translation())
                           .cast<float>();
        ...
        if (dist > 1) {
          ...
          for (size_t i2 = 0, iend = vpEdgesMono.size(); i2 < iend; i2++) {
            WEB_SLAM::EdgeSE3ProjectXYZ *e = vpEdgesMono[i2];
  ...
  int Optimizer::PoseOptimization(Frame *pFrame) {
    ...
    vector<WEB_SLAM::EdgeSE3ProjectXYZOnlyPose *> vpEdgesMono;
    vector<WEB_SLAM::EdgeSE3ProjectXYZOnlyPoseToBody *> vpEdgesMono_FHR;
        ...
        if (pMP) {
          ...
          if (!pFrame->mpCamera2) {
            ...
            if (pFrame->mvuRight[i] < 0) {
              ...
              WEB_SLAM::EdgeSE3ProjectXYZOnlyPose *e =
                  new WEB_SLAM::EdgeSE3ProjectXYZOnlyPose();
          ...
          // SLAM with respect a rigid body
            ...
            if (i < pFrame->Nleft) { // Left camera observation
              ...
              WEB_SLAM::EdgeSE3ProjectXYZOnlyPoseToBody *e =
                  new WEB_SLAM::EdgeSE3ProjectXYZOnlyPoseToBody();
    ...
    for (size_t it = 0; it < 4; it++) {
      ...
      for (size_t i = 0, iend = vpEdgesMono.size(); i < iend; i++) {
        WEB_SLAM::EdgeSE3ProjectXYZOnlyPose *e = vpEdgesMono[i];
      ...
      for (size_t i = 0, iend = vpEdgesMono_FHR.size(); i < iend; i++) {
        WEB_SLAM::EdgeSE3ProjectXYZOnlyPoseToBody *e = vpEdgesMono_FHR[i];
  ...
  void Optimizer::LocalBundleAdjustment(KeyFrame *pKF,
    ...
    for (size_t i = 0, iend = vpEdgesMono.size(); i < iend; i++) {
      WEB_SLAM::EdgeSE3ProjectXYZ *e = vpEdgesMono[i];
    ...
    for (size_t i = 0, iend = vpEdgesBody.size(); i < iend; i++) {
      WEB_SLAM::EdgeSE3ProjectXYZToBody *e = vpEdgesBody[i];
  ...
  void
  Optimizer::OptimizeEssentialGraph(KeyFrame *pCurKF,
  ...
  int Optimizer::OptimizeSim3(KeyFrame *pKF1,
    ...
    // Set Sim3 vertex
    WEB_SLAM::VertexSim3Expmap *vSim3 = new WEB_SLAM::VertexSim3Expmap();
    vSim3->_fix_scale = bFixScale;
    ...
    vector<WEB_SLAM::EdgeSim3ProjectXYZ *> vpEdges12;
    vector<WEB_SLAM::EdgeInverseSim3ProjectXYZ *> vpEdges21;
    ...
    for (int i = 0; i < N; i++) {
      ...
      WEB_SLAM::EdgeSim3ProjectXYZ *e12 = new WEB_SLAM::EdgeSim3ProjectXYZ();
      ...
      WEB_SLAM::EdgeInverseSim3ProjectXYZ *e21 =
          new WEB_SLAM::EdgeInverseSim3ProjectXYZ();
    ...
    for (size_t i = 0; i < vpEdges12.size(); i++) {
      WEB_SLAM::EdgeSim3ProjectXYZ *e12 = vpEdges12[i];
      WEB_SLAM::EdgeInverseSim3ProjectXYZ *e21 = vpEdges21[i];
      if (!e12 || !e21) {
        continue;
      }
      ...
      if (e12->chi2() > th2 || e21->chi2() > th2) {
        ...
        vpEdges12[i] = static_cast<WEB_SLAM::EdgeSim3ProjectXYZ *>(NULL);
        vpEdges21[i] = static_cast<WEB_SLAM::EdgeInverseSim3ProjectXYZ *>(NULL);
        nBad++;
  ...
  int Optimizer::PoseInertialOptimizationLastFrame(Frame *pFrame,
                                                   bool bRecInit) {
    g2o::SparseOptimizer optimizer;
    g2o::BlockSolverX::LinearSolverType *linearSolver;
