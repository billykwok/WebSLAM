#ifndef WEB_SLAM_OPTIMIZABLETYPES_H
#define WEB_SLAM_OPTIMIZABLETYPES_H

#include "libs/g2o/g2o/core/base_unary_edge.h"
#include <Eigen/Geometry>
#include <include/CameraModels/GeometricCamera.h>
#include <libs/g2o/g2o/types/sim3.h>
...
namespace WEB_SLAM {
  ...
  class EdgeSim3ProjectXYZ
    ...
    public:
      ...
      void computeError() {
        const WEB_SLAM::VertexSim3Expmap *v1 =
            static_cast<const WEB_SLAM::VertexSim3Expmap *>(_vertices[1]);
        const g2o::VertexSBAPointXYZ *v2 =
            static_cast<const g2o::VertexSBAPointXYZ *>(_vertices[0]);
...
#endif // WEB_SLAM_OPTIMIZABLETYPES_H
