#ifndef WEB_SLAM_MLPNPSOLVER_H
#define WEB_SLAM_MLPNPSOLVER_H
...
namespace WEB_SLAM {
  class MLPnPsolver {
    public:
      ...
      /** A 2-matrix containing the 2D covariance information of a bearing
       * vector
       */
      typedef Eigen::Matrix2d cov2_mat_t;

      /** A 3-matrix containing the 3D covariance information of a bearing
       * vector */
       ...
       *  \f$ \left( \begin{array}{cc} \mathbf{R} & \mathbf{t} \end{array}
       * \right) \f$
       */
    ...
    private:
       ...
       * reference system), the camera rays and (optionally) the covariance
       * matrix of those camera rays. Result is stored in solution
       */
