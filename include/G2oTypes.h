...
#include "Converter.h"
#include "libs/g2o/g2o/core/base_binary_edge.h"
#include "libs/g2o/g2o/core/base_multi_edge.h"
#include "libs/g2o/g2o/core/base_unary_edge.h"
#include "libs/g2o/g2o/core/base_vertex.h"
#include "libs/g2o/g2o/types/types_sba.h"
#include <Eigen/Core>
#include <Eigen/Dense>
...
namespace WEB_SLAM {
  ...
  // Edge inertial whre gravity is included as optimizable variable and it is
  // not supposed to be pointing in -z axis, as well as scale
  ...
  class EdgeGyroRW
      : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, VertexGyroBias,
                                   VertexGyroBias> {
    public:
      EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  class EdgeAccRW : public g2o::BaseBinaryEdge<3, Eigen::Vector3d,
  ...
  class Edge4DoF : public g2o::BaseBinaryEdge<6, Vector6d, VertexPose4DoF,
                                              VertexPose4DoF> {
    public:
      EIGEN_MAKE_ALIGNED_OPERATOR_NEW
